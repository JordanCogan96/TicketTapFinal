...
public class SecurityLoginActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.securityForgotPasswordBtn).setOnClickListener(this);
        ...
        mAuth.signInWithEmailAndPassword(email, password).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
            ...
            public void onComplete(@NonNull Task<AuthResult> task) {
                if (task.isSuccessful()) {
                    //Advance to Profile
                    Intent intent = new Intent(SecurityLoginActivity.this, SecurityHome.class);
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            case R.id.buttonLogin:
                userLogin();
                break;
            case R.id.securityForgotPasswordBtn:
